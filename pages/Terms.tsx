      ...
      <Container className="relative z-10">
        <article className="max-w-3xl mx-auto pb-24">
            <header className="mb-12">
                <h1 className="text-5xl md:text-7xl font-display font-bold mb-4 tracking-tighter">Terms of Service</h1>
                <time className="font-mono text-xs text-coral uppercase tracking-widest block">Effective Date: November 14, 2025</time>
            </header>
            ...
            <div className="prose prose-invert prose-lg">
                ...
                <footer className="mt-12 pt-12 border-t border-white/10">
                    <div className="text-sm text-gray-500">
                        <strong className="text-white block mb-2">Contact Us</strong>
                        <p className="mb-4">
                            If you have any questions about these Terms, please contact us:<br/>
                            <a href="mailto:info@asymmetric.al" className="text-white hover:text-primary transition-colors">
                                info@asymmetric.al
                            </a>
                        </p>
                        
                        <strong className="text-white block mb-2">Mailing Address:</strong>
